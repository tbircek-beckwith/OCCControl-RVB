        ...
        Try
            ...
            With RVBSim
                ...
                If ProtocolInUse = "dnp" Then
                    ...
                    'set RVB Max
                    WriteEvent.Reset()
                    dnp.Send(WriteEvent, .DNPDestinationReg1.Value, .DNPSourceReg1.Value, Mode.DirectOp, Objects.AnalogOutput, Variations.AnaOutBlockShort, QualifierField.AnaOutBlock16bitIndex, 1, dnpSetting.RVBMax, .RVBMax.Value * M2001D_Comm_Scale, 0)
                    WriteEvent.WaitOne()

                    'set RVB Min
                    WriteEvent.Reset()
                    dnp.Send(WriteEvent, .DNPDestinationReg1.Value, .DNPSourceReg1.Value, Mode.DirectOp, Objects.AnalogOutput, Variations.AnaOutBlockShort, QualifierField.AnaOutBlock16bitIndex, 1, dnpSetting.RVBMin, .RVBMin.Value * M2001D_Comm_Scale, 0)
                    WriteEvent.WaitOne()

                    'set Fwd RVB Scale Factor
                    WriteEvent.Reset()
                    dnp.Send(WriteEvent, .DNPDestinationReg1.Value, .DNPSourceReg1.Value, Mode.DirectOp, Objects.AnalogOutput, Variations.AnaOutBlockShort, QualifierField.AnaOutBlock16bitIndex, 1, dnpSetting.FRVBScale, .FRVBScaleReg1.Value * M2001D_Comm_Scale, 0)
                    WriteEvent.WaitOne()

                    'set Rev RVB Scale Factor 
                    WriteEvent.Reset()
                    dnp.Send(WriteEvent, .DNPDestinationReg1.Value, .DNPSourceReg1.Value, Mode.DirectOp, Objects.AnalogOutput, Variations.AnaOutBlockShort, QualifierField.AnaOutBlock16bitIndex, 1, dnpSetting.RRVBScale, .RevRVBScaleFactorReg1.Value * M2001D_Comm_Scale, 0)
                    WriteEvent.WaitOne()
                ...
                ElseIf ProtocolInUse = "modbus" Then
                    ...
                    'set Fwd RVB Scale Factor
                    modbusWrite.WriteSingleRegister(modbusRegister.FRVBScale, .FRVBScaleReg1.Value * M2001D_Comm_Scale)

                    'set Rev RVB Scale Factor 
                    modbusWrite.WriteSingleRegister(modbusRegister.RRVBScale, .RevRVBScaleFactorReg1.Value * M2001D_Comm_Scale)
                ...
                ElseIf ProtocolInUse = "iec" Then
                    ...
                    'set Fwd RVB Scale Factor
                    WriteEvent.Reset()
                    iec61850.Send(WriteEvent, iecSetting.FRVBScale, "Write", .FRVBScaleReg1.Value * M2001D_Comm_Scale, DataType.int)
                    WriteEvent.WaitOne()

                    'set Rev RVB Scale Factor
                    WriteEvent.Reset()
                    iec61850.Send(WriteEvent, iecSetting.RRVBScale, "Write", .RevRVBScaleFactorReg1.Value * M2001D_Comm_Scale, DataType.int)
                    WriteEvent.WaitOne()
