    ...
    Public Sub Decide(ByRef rvbForm As RVBSim, ByVal sender As RadioButton)
        ...
        Select Case rb.Text
            ...
            Case $"Use Absolute"
                ...
                'If LocalVoltageReadresult / BecoCommunicationScaleFactor >= fwdVoltage.Minimum Then
                '    fwdVoltage.Value = LocalVoltageReadresult / BecoCommunicationScaleFactor
                'Else
                '    fwdVoltage.Value = fwdVoltage.Maximum
                'End If
                'If SourceVoltageReadresult / BecoCommunicationScaleFactor >= revVoltage.Minimum Then
                '    revVoltage.Value = SourceVoltageReadresult / BecoCommunicationScaleFactor
                'Else
                '    revVoltage.Value = revVoltage.Minimum
                'End If
        End Select
        ' End If
